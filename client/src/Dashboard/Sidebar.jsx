    ...
    <div
      className={`fixed h-screen md:static ${
        isSidebarOpen
          ...
          : "-left-full w-80"
      } top-0 h-full shadow-[4px_0_10px_rgba(0,0,0,0.25)] bg-white z-[51]`}
    >
            ...
            <>
              <Tooltip placement="right" arrow title="Transfered Units">
                <button
                  ...
                  className={`cursor-pointer text-lg flex justify-between w-full font-medium mt-5 pl-5 pt-0.5 rounded-3xl h-10`}
                >
                  <div>
            ...
            <>
              <Tooltip placement="right" arrow title="Setup">
                <button
                  ...
                  className={`cursor-pointer text-lg flex w-full justify-between font-medium mt-5 pl-5 pt-0.5 rounded-3xl h-10`}
                >
                  <div>
