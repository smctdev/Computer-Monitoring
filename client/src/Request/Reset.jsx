        ...
        <form onSubmit={handleResetPassword}>
          <FormControl sx={{ m: 1, width: "40ch" }} variant="outlined">
            ...
            <OutlinedInput
              ...
              sx={{
                borderColor: validationErrors.new_password ? "red" : "#ccc",
              }}
              label="New Password"
            />
            <span className="mb-2">
          ...
          <FormControl sx={{ m: 1, width: "40ch" }} variant="outlined">
            ...
            <span className="mb-2">
              {validationErrors.new_password_confirmation && (
                <div className="text-red-500">
                  <ul>
                    {validationErrors.new_password_confirmation.map(
                      (error, index) => (
                        <li key={index}>{error}</li>
                      )
                    )}
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="h-10 mt-5 font-semibold text-white bg-blue-800 rounded-full"
              disabled={loading}
              style={{ width: "192px" }}
            >
